...
public class Main {
    ...
    /**
     * Проверяет, является ли введенное пользователем целое число {@code int} cекундой.
     *
     * @return true, если пользователь ввел секунду
     */
    ...
    /**
     * Вычисляет количество пройденных часов
     *
    ...
    /**
     * Вычисляет количество пройденных минут
     *
    ...
    /**
     * Вычисляет количество пройденных секунд
     *
     * @param remainingSeconds количество секунд, оставшихся после вычисленного
